...
- [6. 作業手順](#6-作業手順)
  ...
  - [6.10. (日レセ)日レセクライアントインストール](#610-日レセ日レセクライアントインストール)
  - [6.11. クライアントから接続できることを確認](#611-クライアントから接続できることを確認)

## 4. 概要

日医標準レセプトソフト（通称：日レセ）の稼働環境を構築するための手順書。
...
### 6.10. (日レセ)日レセクライアントインストール

```Shell
sudo apt install -y panda-client2
```

### 6.11. クライアントから接続できることを確認
